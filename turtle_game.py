...
def draw(turt, set_1, set_2, set_3, mouse, objects, tile_size=50):
...
def main():
    ...
    while running:
        for event in pg.event.get():
            if event.type == pg.QUIT:
                ...
                if dragging and selected_object:
                    ...
                    selected_object.x, selected_object.y = pg.mouse.get_pos()
        ...
        draw(turt, set_1, set_2, set_3, mouse, objects)
